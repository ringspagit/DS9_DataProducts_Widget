...
The national park widget is a shiny app that will provide easy access to examine this data to examine trends, either across all parks or by individual park.  The widget will fit either a spline regression (default), or simple linear regression.
